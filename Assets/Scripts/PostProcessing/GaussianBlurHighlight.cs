...
[ExecuteInEditMode]
public class GaussianBlurHighlight : BasePostProcessing
{
    ...
    protected ComputeBuffer weightsBuffer = default;
    ...
    protected float[] SetWeightsArray(int radius, float sigma)
    {
    ...
    protected void UpdateWeightsBuffer()
    {
